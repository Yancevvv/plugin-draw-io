...
export const ConvertToLogicNode = function (
    ...
    if (theGraph.isEnabled() && !theGraph.isCellLocked(theGraph.getDefaultParent())) {
        ...
        // Установка атрибутов в зависимости от текста
        if (text === "OR") {
            theGraph.setAttributeForCell(addedCell, 'type', "OR");
            theGraph.setAttributeForCell(addedCell, 'label', "OR");
        } else {
            theGraph.setAttributeForCell(addedCell, 'type', "AND");
            theGraph.setAttributeForCell(addedCell, 'label', "AND");
        }
