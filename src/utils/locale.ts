...
/**
 * Все доступные ключи локализации
 * Используется для типобезопасности при вызове getTextByLocale()
 */
export type LocaleKey = 
  // Разделы меню
  | 'menuItemDictionaryConstructors'
  | 'menuItemNodeConstructors'
  | 'menuItemExport'
  | 'menuItemEdit'
  | 'menuItemConverNode'
  ...
  // Элементы меню
  | 'classesConstructor'
  | 'classPropertiesConstructor'
  | 'relationshipsConstructor'
  | 'enumConstructor'
  | 'startNodeConstructor'
  | 'TrueNodeCreate'
  | 'FalseNodeCreate'
  | 'LogicNodeCreate'
  | 'PredeterminingFactorsNodeCreate'
  | 'UncertaintyNodeCreate'
  | 'actionNodeConstructor'
  | 'cycleNodeConstructor'
  | 'whileNodeConstructor'
  | 'conditionNodeConstructor'
  | 'switchCaseNodeConstructor'
  | 'exportClass'
  | 'exportProperty'
  | 'exportRelationship'
  | 'exportEnum'
  ...
  | 'convertFalseNode'
  | 'convertLogicNode'
  | 'convertPredeterminingFactorsNode'
  | 'convertUncertaintyNode'
  | 'convertActionNode'
  | 'convertCycleNode'
  | 'convertConditionNode'
  | 'convertSwitchCaseNode'
  
  // Тексты окон (словари)
  | 'TitleClassConstructorWindow'
  | 'TitleClassEditorWindow'
  | 'TitleClassPropertiesConstructorWindow'
  | 'TitleClassPropertiesEditorWindow'
  | 'TitleEnumConstructorWindow'
  | 'TitleEnumEditorWindow'
  | 'TitleRelationshipsConstructorWindow'
  | 'TitleRelationshipsEditorWindow'
  
  // Тексты окон (узлы)
  | 'TitleActionNodeConstructorWindow'
  | 'TitleActionNodeEditorWindow'
  | 'TitleBranchResultNodeConstructorWindow'
  | 'TitleBranchResultNodeEditorWindow'
  | 'TitleConditionNodeConstructorWindow'
  | 'TitleConditionNodeEditorWindow'
  | 'TitleCycleNodeConstructorWindow'
  | 'TitleCycleNodeEditorWindow'
  | 'TitleWhileNodeConstructorWindow'
  | 'TitleWhileNodeEditorWindow'
  | 'TitleEditTextInNodeWindow'
  | 'TitleEditValueInOutcomeWindow'
  | 'TitleLogicNodeConstructorWindow'
  | 'TitleLogicNodeEditorWindow'
  | 'TitlePredeterminingFactorsNodeConstructorWindow'
  | 'TitlePredeterminingFactorsNodeEditorWindow'
  | 'TitleEditQuestionInfoInNodeWindow'
  | 'TitleEditQuestionInfoInOutcomeWindow'
  | 'TitleStartConstructorWindow'
  | 'TitleStartEditorWindow'
  | 'TitleSwitchCaseNodeConstructorWindow'
  | 'TitleSwitchCaseNodeEditorWindow'
  ...
  | 'textQuestion'
  | 'explanation'
  | 'nextStepQuestionOutcome'
  | 'nextStepBranchResult'
  | 'nextStepExplanationOutcome'
  
  // Ошибки
  | 'nameIsMissing'
  | 'nameIsIncorrect'
  | 'extendClassIsIncorrect'
  | 'nonUniqueClassName'
  | 'ClassExists'
  | 'startValueIsMissing'
  | 'endValueIsMissing'
  ...
  | 'nonUniqueEnumName'
  | 'EnumExists'
  | 'extendRelationshipIsIncorrect'
  | 'nameRelationshipsIsMissing'
  | 'nameRelationshipsIsIncorrect'
  | 'nonUniqueRelationshipName'
  | 'RelationshipExists'
  | 'ExpressionIsMissing'
  | 'NameVariableIsMissing'
  | 'NameVariableIsIncorrect'
  | 'TypeVariableIsMissing'
  | 'sourceNodeIsMissing'
  | 'EnumIsMissing'
  | 'HumanReadableTextIsMissing'
  | 'ValueOutcomeIsMissing'
  | 'ValueInOutcomeIsMissing'
  | 'invalidAssign'
  | 'InvalidType'
  | 'StartNodeOnlyOne'
  | 'typeOutcomeStartNodeIsMissing'
  | 'typeOutcomeCycleIsMissing'
  | 'bodyOnlyOne'
  | 'trueCycleOnlyOne'
  | 'falseCycleOnlyOne'
  | 'typeOutcomeLogicNodeIsMissing'
  | 'OutcomeLogicNodeOnlyTwo'
  | 'trueLogicNodeOnlyOne'
  | 'falseLogicNodeOnlyOne'
  | 'typeOutcomePredIsMissing'
  | 'predOutcomeIsMissing'
  | 'undeterminedOnlyOne'
  | 'valueInOutcomeIsMissing'
  | 'valueEnumIsMissing'
  | 'ClassInDictIsMissing'
  | 'TypesDontMatch'
  | 'OutcomesHasSameValues'
  | 'ResultOutcomeForPredNode'
  | 'moreBlocksInWorkspace'
  | 'propertyIsMissingInDict'
  | 'hasCycleInTree'
  | 'AssignInNode'
  | 'EmptyConnection'
  | 'StartNodeIsTarget'
  ...
  | 'circularDependency'
  | string; // Fallback для динамических ключей

/**
 * Словарь текстов для одной локали
 */
 ...
 */
export type SupportedLanguage = 'ru' | 'en' | string;

// DATA

const RU_TEXT: LocaleDictionary = {
  // Разделы меню
  ...
  // Дополнительные ключи для новых функций
  "ValidationError": "Ошибка валидации",
  "noClassesDefined": "Не определено ни одного класса",
  "unknownError": "Неизвестная ошибка",
  "blocklyError": "Ошибка при работе с Blockly",
  "expressionParseError": "Ошибка парсинга выражения в строке №%i: %e",
  "circularDependency": "Обнаружена циклическая зависимость в классе %c"
};

const EN_TEXT: LocaleDictionary = {
  // Menu sections
  ...
  "blocklyError": "Error working with Blockly",
  "expressionParseError": "Expression parse error in line №%i: %e",
  "circularDependency": "Circular dependency detected in class %c"
};
 ...
 * @param key - ключ локализации из типа LocaleKey
 * @param params - параметры для подстановки в строку (например, { '%i': '5', '%e': 'error' })
 * @returns локализованная строка или ключ, если перевод не найден
 * 
 * @example
 * getTextByLocale('nameIsMissing', { '%i': '3' }) 
 * // => "В строке №3 отсутствует название; "
 */
export function getTextByLocale(
  key: LocaleKey, 
  params?: Record<string, string | number>
): string {
  // Определяем текущий язык (fallback на 'en')
  const language = getCurrentLanguage();
  
  // Выбираем словарь
  const dictionary = language === 'ru' ? RU_TEXT : EN_TEXT;
  
  // Получаем текст (fallback на ключ, если не найдено)
  let text = dictionary[key] ?? key;
  
  // Подстановка параметров, если указаны
  if (params) {
...
export function getCurrentLanguage(): SupportedLanguage {
  // Проверяем mxClient 
  if (typeof mxClient !== 'undefined' && mxClient.language) {
    return mxClient.language;
  }
  
  // Fallback на navigator.language
...
/**
 * Проверяет, существует ли ключ локализации
 * @param key - ключ для проверки
 * @returns true, если ключ есть в обоих словарях
 */
export function hasLocaleKey(key: LocaleKey): boolean {
  return key in RU_TEXT && key in EN_TEXT;
}

/**
 * Возвращает все доступные ключи локализации
 * @returns массив ключей
 */
export function getLocaleKeys(): LocaleKey[] {
  return Object.keys(RU_TEXT) as LocaleKey[];
}

/**
 * Форматирует строку с параметрами (альтернатива параметрам в getTextByLocale)
 * @param template - строка с плейсхолдерами %key
 * @param params - объект с параметрами
 * @returns отформатированная строка
 * 
 * @example
 * formatLocale('Hello %name, you have %count messages', { '%name': 'John', '%count': '5' })
...
// DECLARATIONS FOR EXTERNAL GLOBALS

// Декларация mxClient из draw.io
declare global {
  interface mxClientStatic {
    language: string;
  }
  
  const mxClient: mxClientStatic;
}

// LEGACY EXPORT (для обратной совместимости)

/**
 * @deprecated Использование именованного экспорта `getTextByLocale`
 */
export const getTextByLocaleLegacy = getTextByLocale;